<template>
    <div class="w-full h-full flex flex-col items-center bg-400 border-r-4 border-color-500 z-50">
        <div class="w-full py-5 h-auto flex flex-col items-center border-b-2 border-gray-600 hover:bg-300 transition duration-200 md:hidden"
        @click="collapse">
            <img src="/icons/collapse.png" class="w-[40px] h-[40px]">
        </div>
        <div class="w-full py-5 h-auto flex flex-col items-center hover:bg-300 transition duration-200"
...
<script setup lang="ts">
    ...
    const navigators = computed<Unit[]>(() => [
        ...
        { id: 3, url: '/icons/lucky-draw.png', text: t('sidebar.lucky_draw'), router: '/lucky-draw' },
        { id: 4, url: '/icons/settings.png', text: t('sidebar.settings'), router: '/settings' },
    ]);
