<template>
    <div
        class="w-full h-full big-bg flex flex-col items-start p-10"
    ...
    >
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            ...
            <select
                id="class"
                v-model="class_name"
                class="border-2 border-black rounded-[4px]"
            >
                <option
                    v-for="(class_name, class_id) in classes"
                    :key="class_id"
                    :value="class_id"
                >
                    {{ class_name }}
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            ...
            >
                <option
                    v-for="(lang, langAbbr) in languages"
                    :key="langAbbr"
                    :value="langAbbr"
                >
                    {{ lang }}
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                ...
                <label
                    for="blue"
                    class="px-3 text-blue-500 text-2xl font-extrabold"
                    >{{ t('settings.color_style.options.blue') }}</label
                >
            </div>
            ...
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                ...
                <label
                    for="pink"
                    class="px-3 text-pink-500 text-2xl font-extrabold"
                    >{{ t('settings.color_style.options.pink') }}</label
                >
            </div>
            ...
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                ...
                <label
                    for="green"
                    class="px-3 text-green-500 text-2xl font-extrabold"
                    >{{ t('settings.color_style.options.green') }}</label
                >
            </div>
            ...
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                <input
                    ...
                    v-model="style"
                />
                <label for="custom" class="px-3 text-2xl font-extrabold">{{
                    t('settings.color_style.options.custom')
                }}</label>
                <div
                    class="p-0.5 flex flex-row items-center border-2 border-black rounded-[4px]"
                >
                    <input type="color" class="p-0" v-model="custom_color" />
                    <span class="px-0.5">{{
                        t('settings.color_style.color_picker')
                    }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                <input
                    ...
                    v-model="order"
                />
                <label for="order1" class="px-3 text-2xl font-extrabold">{{
                    t('settings.display_order.options.chronological')
                }}</label>
            </div>
            ...
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                <input
                    ...
                    v-model="order"
                />
                <label for="order-1" class="px-3 text-2xl font-extrabold">{{
                    t('settings.display_order.options.reverse')
                }}</label>
            </div>
        </div>
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                <input
                    ...
                    v-model="is0Shown"
                />
                <label for="is0Shown-t" class="px-3 text-2xl font-extrabold">{{
                    t('settings.display_zero_scores.options.yes')
                }}</label>
            </div>
            ...
            <div class="flex flex-row items-center pb-1.5 lg:pb-0">
                <input
                    ...
                    v-model="is0Shown"
                />
                <label for="is0Shown-f" class="px-3 text-2xl font-extrabold">{{
                    t('settings.display_zero_scores.options.no')
                }}</label>
            </div>
        </div>
        ...
        <div class="w-full h-auto flex flex-col lg:flex-row pl-3 mb-10">
            ...
            <input
                type="number"
                id="highlightTopN"
                v-model="highlightTopN"
                min="1"
                max="100"
                class="border-2 border-black rounded-[4px] px-2 py-1 w-20"
            />
        </div>
    </div>
...
import {
    apply_color,
    remove_all_color,
} from '../composables/settings/apply_color';
...
// 初始化highlightTopN选择
const highlightTopN = ref<number>(
    Number(localStorage.getItem('highlightTopN')) || 3,
);
