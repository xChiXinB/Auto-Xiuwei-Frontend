<template>
  ...
  <template v-else>
    <h1 class="text-9xl absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">Please wait...</h1>
  </template>

  <router-link class="absolute bottom-5 left-5 text-2xl underline text-blue-950 hover:text-blue-700" to="/lucky-draw">
      Lucky Draw
  </router-link>
</template>
